...
public class SysUtil {
     ...
     * JVM的版本
     */
    public static final String JVM_VERSION = key("java.version");
    /**
     * JVM的编码
     */
    public static final String JVM_ENCODING = key("file.encoding");
    /**
     * JVM默认的临时目录
     */
    public static final String JVM_TEMPDIR = key("java.io.tmpdir");
     ...
     * 主机架构
     */
    public static String OS_ARCH = key("os.arch");
    /**
     * 主机类型
     */
    public static String OS_NAME = key("os.name");
    /**
     * 主机类型版本
     */
    public static String OS_VERSION = key("os.version");
    /**
     * 操作系统类型
     */
    public static String SUN_DESKTOP = key("sun.desktop");
    /**
     * 当前用户
     */
    public static String CURRENT_USER = key("user.name");
    /**
     * 当前用户的家目录
     */
    public static String CURRENT_USER_HOME = key("user.home");
    /**
     * 当用用户的工作目录
     */
    public static String CURRENT_USER_DIR = key("user.dir");
    public static String FILE_SEPARATOR = key("file.separator");
    public static String PATH_SEPARATOR = key("path.separator");
    public static String LINE_SEPARATOR = key("line.separator");
    /**
     * 总的物理内存
     */
